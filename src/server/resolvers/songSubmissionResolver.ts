...
export class SongSubmissionResolver {
    ...
    async addSongSubmission(@Arg('prompt_id') prompt_id: string, @Arg('song', (type)=>SongInput) song: SongInput,  @Arg('submitted_by') submitted_by: string): Promise<SongSubmission>{
