    ...
    console.log(data.getSongSubmissionById);
        return(
            <Grid item className={classes.grid} xs={12} sm={6} md={4} lg={3} xl={2}>
                ...
                <iframe className={classes.player} src={`https://open.spotify.com/embed/track/${data.getSongSubmissionById.song.id}?utm_source=generator`} width="100%" height="80" frameBorder="0"  allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
